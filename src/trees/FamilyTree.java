...
public class FamilyTree {
	...
	private void addLine(String line) throws TreeException {
		...
		if (root == null) {
			...
			//??? If the parent node wasn't found, there must have been 
			//something wrong in the data file. Throw an exception.
			parentNode = root.getNodeWithName(parent);
	        if (parentNode == null) {
	            throw new TreeException("Invalid parent name: " + line);
	        }
		}
